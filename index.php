  ...
  <div class="row">
    <div class="col-md-6">
        ...
        <div class="banner-text">
          ...
          <p class="bt2"><span class="bt3">Pikolos</span>Store</p>
...
<section>
  ...
  <?php
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            <div style="text-align: center; border-radius: 4px; max-width: 100%; padding: 10px;margin-left: 30px;
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-lg-6 col-sm-12">
        <span class="welcometitle">Welcome to Our Online Site</span>
